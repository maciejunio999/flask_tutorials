        ...
        "tasks": [
                    {
                        ...
                        "date": "2020-11-26 13:50:03",
                        "timestamp": "2021-11-30 10:22:27"
                    },
        ]
    },
    {
...
with app.app_context():
    ...
    for data in PEOPLE_TASKS_COMMENTS:
        ...
        for task in data.get('tasks'):
            new_task = Task(name = task.get('name'), date = task.get('date'), timestamp = datetime.strptime(task.get('timestamp'), "%Y-%m-%d %H:%M:%S"))
